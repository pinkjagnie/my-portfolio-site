    ...
    <section id="portfolio" className='pb-8'>
      ...
      <div className='lg:grid lg:grid-cols-2 lg:grid-rows-2 lg:gap-2 lg:pt-4 max-w-[1100px] lg:mx-auto'>
        ...
        <div className='w-[95%] mx-auto mb-8 border-2 border-[#d66382] p-2 rounded-sm min-[540px]:w-[75%] md:w-[60%] lg:w-[80%]'>
          ...
          <div className='axiomPreviewImage w-[280px] h-[120px] min-[360px]:w-[310px] min-[360px]:h-[150px] my-2 mx-auto border'></div>
        ...
        <div className='w-[95%] mx-auto mb-8 border-2 border-[#d66382] p-2 rounded-sm min-[540px]:w-[75%] md:w-[60%] lg:w-[80%]'>
          ...
          <div className='weatherPreviewImage w-[280px] h-[120px] min-[360px]:w-[310px] min-[360px]:h-[150px] my-2 mx-auto border'></div>
        ...
        <div className='w-[95%] mx-auto mb-8 border-2 border-[#d66382] p-2 rounded-sm min-[540px]:w-[75%] md:w-[60%] lg:w-[80%]'>
          ...
          <div className='moviePreviewImage w-[280px] h-[120px] min-[360px]:w-[310px] min-[360px]:h-[150px] my-2 mx-auto border'></div>
        ...
        <div className='w-[95%] mx-auto border-2 border-[#d66382] p-2 rounded-sm min-[540px]:w-[75%] md:w-[60%] lg:w-[80%]'>
          ...
          <div className='chatPreviewImage w-[280px] h-[120px] min-[360px]:w-[310px] min-[360px]:h-[150px] my-2 mx-auto border'></div>
